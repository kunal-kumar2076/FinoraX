    ...
    return ( 
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                <h1 style={{color:"#424242",font:"38px inter,serif"}}>To create a ticket, select a relevant topic</h1>
                <div className='col-4 mt-5'>
                    <h4 className='mb-4' style={{color:"#424242",font:"28px inter,serif"}}><i class="fa fa-plus-circle" aria-hidden="true"></i>  Account Opening</h4>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Charge at Trade</a><br/>
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Getting Started</a>
                    
                </div>
                <div className='col-4 mt-5'>
                    <h4 className='mb-4' style={{color:"#424242",font:"28px inter,serif"}}><i class="fa fa-address-book" aria-hidden="true"></i>  Your Trade Account</h4>
                ...
                <div className='col-4 mt-5'>
                    <h4 className='mb-4' style={{color:"#424242",font:"28px inter,serif"}}><i class="fa fa-bar-chart" aria-hidden="true"></i>  Your Trade Account</h4>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Pi and other platfrom</a>
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Stockreports</a>
                </div>
            </div>
            <div className='row p-5 mb-5'>
                <div className='col-4 '>
                    <h4 className='mb-4' style={{color:"#424242",font:"28px inter,serif"}}><i class="fa fa-id-card-o" aria-hidden="true"></i>  Funds</h4>
                ...
                <div className='col-4 '>
                    <h4 className='mb-4' style={{color:"#424242",font:"28px inter,serif"}}><i class="fa fa-circle-o-notch" aria-hidden="true"></i>  Console</h4>
                ...
                <div className='col-4'>
                    <h4 className='mb-4' style={{color:"#424242",font:"28px inter,serif"}}><i class="fa fa-circle-thin" aria-hidden="true"></i>  Coin</h4>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Staring an SIP</a><br/>
