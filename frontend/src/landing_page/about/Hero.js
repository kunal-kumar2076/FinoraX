...
function Hero() {
    return ( 
        <div className='container mt-5'>
            <div className='row' style={{color:"#424242",font:"18px inter,serif",margin:"15px",fontSize:"1.2em",lineHeight:"1.8"}}>
                <div className='col ms-5 p-5 text-muted'>
                ...
                <div className='col me-5 p-5 text-muted'>
                    ...
                    <p>Rainmatter, our fintech fund and incubator, has invested <br/>in several fintech startups with the goal of growing the <br/>Indian capital markets.</p>
